    ...
    if(jQuery(".dz-theme-mode").length>0) {
        jQuery('.dz-theme-mode').on('click',function(){
            ...
            if(jQuery(this).hasClass('active')){
                ...
                jQuery(".nav-header .logo-abbr").attr("src", "../Finlab/images/logo-white.png");
                jQuery(".nav-header .logo-compact").attr("src", "../Finlab/images/logo-text-white.png");
                jQuery(".nav-header .brand-title").attr("src", "../Finlab/images/logo-text-white.png");
                
                setCookie('logo_src', '../Finlab/images/logo-white.png');
                setCookie('logo_src2', 'images/logo-text-white.png');
            }else{
                jQuery('body').attr('data-theme-version','light');
                setCookie('version', 'light');
                jQuery('#theme_version').val('light');	
                jQuery(".nav-header .logo-abbr").attr("src", "../Finlab/images/logo.png");
                jQuery(".nav-header .logo-compact").attr("src", "../Finlab/images/logo-text.png");
                jQuery(".nav-header .brand-title").attr("src", "../Finlab/images/logo-text.png");
                
                setCookie('logo_src', '../Finlab/images/logo.png');
